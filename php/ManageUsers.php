...
<main>
	<h1 class="slideInDown animated">Add or Update a User</h1>
	<div class="form-style-5 slideInDown animated">
		...
		<form>
			...
			<fieldset>
				...
				<input type="text" name="number" id="number" placeholder="User Phone Number...">
	...
	Để làm cho các cột có chiều rộng bằng nhau, bạn có thể sử dụng thuộc tính table-layout: fixed; trong CSS và đặt chiều rộng của các cột bằng nhau. Dưới đây là một ví dụ:
...
<style>
    ...
    .tbl-header table {
        width: 100%;
        table-layout: fixed; /* Sử dụng table-layout: fixed để các cột có chiều rộng bằng nhau */
    }

    .tbl-header th {
        width: 20%; /* Đặt chiều rộng của mỗi cột, bạn có thể điều chỉnh theo nhu cầu */
    }
    ...
    .tbl-content td {
        width: 20%; /* Đặt chiều rộng của mỗi cột */
    }
</style>
	<div class="section">
